...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/home/yluo37/yluo37/cvpr2024/Block-Wise-MAE/Imagenet/Block-Wise-Distribution/checkpoint/").is_dir():
        p = Path(f"/home/yluo37/yluo37/cvpr2024/Block-Wise-MAE/Imagenet/Block-Wise-Distribution/checkpoint/{user}/experiments")
